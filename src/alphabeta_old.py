def alphabeta(self, evalboard, depth, player, maximizing=True):
    ...
    if maximizing:
        ...
        for i in game.get_available_moves(evalboard, player_mm):
            ...
            if game.playerrepeat == True:
                value = self.alphabeta(child, depth - 1, player_mm, True)[0]
            else:
                value = self.alphabeta(child, depth - 1, player_mm, False)[0]
